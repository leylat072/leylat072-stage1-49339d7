...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoibGV5bGFtYXBib3giLCJhIjoiY2prbXA0ZG1qMGZ4aTNrdWtxMm5ka3Q0eCJ9.zh0ux6ZHWUU6PSdYL5JULA',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  var imgurlbase1 = imgurlbase.split(".")[0];
  const imgurl1x = imgurlbase1 + "_1x.jpg";
  const imgurl2x = imgurlbase1 + "_2x.jpg";
  image.src = imgurl1x;
  ...
  div2.className = "view-detail-div";
  const more = document.createElement('button');
 
  const amore = document.createElement('a');
  amore.href = '#';
  amore.className ='ViewDetailClass';
